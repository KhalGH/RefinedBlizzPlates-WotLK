...
L["Party/Raid Color"] = true
L["Use a custom color for party and raid member nameplates."] = true
L["Party/Raid Class Colors"] = true
L["Use class colors for party and raid member nameplates."] = true
L["Glows"] = true
