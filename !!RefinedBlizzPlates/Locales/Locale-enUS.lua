...
L["Global Scale"] = true
L["Scales both the visual size and the clickbox of nameplates."] = true
L["Global Offset X"] = true
L["Global Offset Y"] = true
L["Affects only the nameplate's visual regions. The clickbox can't be moved using this feature."] = true
...
L["Adjusts friendly nameplate scale, applied multiplicatively with the global scale. Affects the visual size and the clickbox"] = true
L["Box Selection Space"] = true
...
L["Vertically offsets the entire nameplate, including its clickbox."] = true
...
L["Use class colors for friendly player nameplates (only works for party or raid members)."] = true
...
L["Health Bar"] = true
L["Appearance"] = true
L["Friendly Player Texture"] = true
L["Hostile Player Texture"] = true
L["NPC Texture"] = true
...
L["Percent 1 dec."] = true
L["Current"] = true
L["Current / Max"] = true
L["Current (Perc.)"] = true
L["Deficit"] = true
L["Hide on max health"] = true
L["Text Color"] = true
L["Hide Health Text"] = true
L["Aggro Coloring"] = true
L["Enable"] = true
L["Changes NPC health bar color based on aggro status."] = true
L["Aggro"] = true
...
L["Adjusts the visual vertical position (does not affect the clickbox)."] = true
...
L["Blacklist"] = true
L["Unit name"] = true
L["Add the exact name of a unit whose nameplate you want to hide or replace with an icon."] = true
